    ...
    a.prototype = {constructor:a, initInput:function () {
        ...
        if (e) {
            ...
            if (typeof this.options.url === "function") {
                ...
                return b.ajax(b.extend({url:"http://localhost/system/user/profile"+this.options.url,
                    data:f, type:"POST"}, this.options.ajaxOptions))
            }
        }
    }, validate:function (c) {
        if (c === undefined) {
        ...
        switch (h) {
            ...
            case"submit":
                ...
                if (b.isEmptyObject(i)) {
                    ...
                    b.ajax(b.extend({url:f.url, data:d, type:"POST"}, f.ajaxOptions)).success(
                        function (k) {
...
(function (g) {
    ...
    h.prototype = {constructor:h, _process_options:function (n) {
        ...
        var p = parseInt(this.element.parents().filter(
            function () {
