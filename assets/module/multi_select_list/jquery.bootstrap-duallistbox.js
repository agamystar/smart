  ...
  BootstrapDualListbox.prototype = {
    init: function () {
      ...
      this.container = $('' +
        ...
        "      <img src="+js_site_url+"/assets/img/all_to_right.png"+">"+
        '     </button>' +
        '     <button type="button" class="btn move">' +
          "      <img src="+js_site_url+"/assets/img/to_right.png"+">"+
        '     </button>' +
        '   </div>' +
        ...
        '     <button type="button" class="btn remove">' +
          "      <img src="+js_site_url+"/assets/img/to_left.png"+">"+
        '     </button>' +
        '     <button type="button" class="btn removeall">' +
          "      <img src="+js_site_url+"/assets/img/all_to_left.png"+">"+
        '     </button>' +
        '   </div>' +
        '   <select multiple="multiple"></select>' +
        ' </div>' +
