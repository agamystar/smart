    ...
    public function index()
    {
        ...
        if ($action_get == "get_data") {
            ...
            $flds_array = array(
                ...
                'key' => array('where' => "key", 'order' => "key", 'val_template' => '', 'lower' => true),
                'english' => array('where' => "english", 'order' => "english", 'val_template' => '', 'lower' => true),
                'arabic' => array('where' => "arabic", 'order' => "arabic", 'val_template' => '', 'lower' => true),
            );
       ...
       //  echo $this->db->last_query();
        ...
        $data['js'][] = "usage/translation.js";
        $this->load->view('admin' . DIRECTORY_SEPARATOR . 'translation', $data);
